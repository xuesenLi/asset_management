...
var vm = new Vue({
    ...
    methods: {
        ...
        init: function(recordNo){
            ...
            $.get(baseURL + "asset/assettransfer/infoByRecordNo/"+ recordNo, function(r){
                vm.assetTransfer = r.assetTransfer;
                if(r.assetTransfer.recordStatus === 0){
                    // 表示为待审批
                    vm.isBtn = true;
                }
            });
        ...
        save: function(){
            $.ajax({
                type: "POST",
                url: baseURL + "asset/assettransfer/agree",
        ...
        rebut: function(){
            $.ajax({
                type: "POST",
                url: baseURL + "asset/assettransfer/rebut",
                data: "recordNo=" + vm.recordNo,
                success: function(r){
                    if(r.code === 0){
                        alert('操作成功', function(){
